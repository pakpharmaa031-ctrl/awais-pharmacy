[README.md](https://github.com/user-attachments/files/23688150/README.md)
# AwaisPharmacy  - Professional Pharmacy Management System

A complete, role-based pharmacy management software with separate interfaces for **Owner** and **Customers**.
